...
import { Mail, Lock, Github, Loader2, ArrowLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="flex items-center justify-between px-8 py-4 border-b border-border/30">
        <div className="flex items-center gap-4">
          <Link
            ...
            {t("auth.login.back") !== "auth.login.back" ? t("auth.login.back") : t("nav.back") !== "nav.back" ? t("nav.back") : "Retour"}
          </Link>
      ...
      <div className="flex-1 flex">
        ...
        <div className="hidden lg:flex flex-col justify-center flex-1 px-16 py-12 bg-card/30">
          <div className="max-w-lg">
            ...
            <h1 className="text-4xl xl:text-5xl font-bold text-foreground leading-tight mb-6">
              Master the <span className="text-accent">Architecture</span> of Innovation.
            </h1>
            <p className="text-lg text-muted-foreground mb-12">
              Access high-precision certification tracks designed for elite software engineers and technical architects.
            </p>
            <div className="flex gap-4">
              <div className="flex-1 p-4 bg-card/50 border border-border/50 rounded-lg">
                ...
                <span className="text-sm font-mono text-muted-foreground">Precision Tools</span>
              </div>
              <div className="flex-1 p-4 bg-card/50 border border-border/50 rounded-lg">
                ...
                <span className="text-sm font-mono text-muted-foreground">Verified Tracks</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-8 py-12 bg-background">
          <div className="w-full max-w-md">
            <h2 className="text-3xl font-bold text-foreground mb-2">{t("auth.login.title")}</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                className="w-full h-12 bg-primary text-primary-foreground hover:bg-primary/90 font-medium tracking-widest uppercase disabled:opacity-50">
                {isLoggingIn ? (
                  <>
            ...
            <div className="flex gap-4">
              <Button variant="outline" disabled className="flex-1 h-12 bg-card border-border/50 text-foreground hover:bg-card/80 disabled:opacity-50">
      ...
      <footer className="px-8 py-6 border-t border-border/30">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-sm font-mono text-muted-foreground">SkillForge<br />Engineering</div>
